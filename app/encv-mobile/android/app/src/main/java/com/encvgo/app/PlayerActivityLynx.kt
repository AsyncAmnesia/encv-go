...
// 注意：PlayerOverlayManager 仍引用此类作为覆盖层模式的 LynxView 宿主，迁移完成前保留编译
...
class PlayerActivityLynx : AppCompatActivity() {
    ...
    private fun buildInitDataJson(): String {
        ...
        LogRelay.get().relay(TAG, "info", "buildInitDataJson: filePath=$intentFilePath, isExternal=$isExternalFile")
