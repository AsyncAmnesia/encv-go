...
// func (p *AudioPlugin) Initialize(provider pluginInterfaces.ConfigProvider) error {
...
// 	// 2. 使用新的通用辅助函数解析配置
// 	settings, err := pluginInterfaces.UnmarshalPluginSettings[AudioPluginConfig](rawSettings, p.Name())
// 	if err != nil {
